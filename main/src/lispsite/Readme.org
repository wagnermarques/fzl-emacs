...
| projectile         |               | installed | melpa  | Project Interaction Library            |   |
| helm-projectile    |               | installed | melpa  | Helm UI for Projectile                 |   |
| treemacs           |               | installed | melpa  | Tree style file and project explorer   |   |
| treemacs-projectile|               | installed | melpa  | Projectile integration for Treemacs    |   |

* Treemacs & Projectile Integration
Para um guia completo de produtividade e atalhos, consulte:
[[file:treemacs-projectile-guide.org][Guia de Produtividade Treemacs & Projectile]]

** Atalhos Rápidos:
| C-c p p | projectile-switch-project                     | Troca de projeto com busca fuzzy      |
| C-c p f | projectile-find-file                          | Busca rápida de arquivo no projeto    |
| C-c p h | treemacs-projectile                           | Adiciona projeto Projectile no treemacs |
| C-c p T | treemacs-add-and-display-current-project      | Exibe projeto atual no treemacs       |
| C-c t   | treemacs                                      | Abre/fecha a barra lateral Treemacs   |
| M-0     | treemacs-select-window                        | Foca o cursor na barra Treemacs       |
