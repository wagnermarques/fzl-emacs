...
(setq **SOMEWRITENS_HOME** (concat **DISK** "/fzlbpms/somewritings"))
...
(setq **FZL_HOME_SERVER** (concat **DISK** "/fzlbpms/fzlServer"))
...
(setq **GRADLE_HOME** (concat **FZL_HOME** "/integrated/build/gradle-6.5"))
(setenv "GRADLE_HOME" **GRADLE_HOME**)
(setenv "PATH" (concat (concat (getenv "PATH") ":") (concat **GRADLE_HOME** "/bin")))

;;;MAVEN ENVIROMENT VARIABLES
(setq **M2_HOME** (concat **FZL_HOME** "/integrated/build/apache-maven-3.6.3"))
...
(setq **KARAF_HOME** (concat **FZL_HOME_SERVER** "/integrated/apache-karaf-4.2.9"))
...
(setq **ANDROID_SDK_ROOT** (concat **DISK** "/Android/Sdk"))
