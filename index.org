...
The [[file:install-dev-packages.sh]] file presents the development packages that you should choose to install

Beside development tasks, some academic tasks is considered, like
latex, etc..

The [[file:bookmark.org]] file has a collection of interesting links..
