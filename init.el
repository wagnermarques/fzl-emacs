...
(message "\n\n\n
-----------------------------------
U S I N G    T H I S    G L O B A L    V A R I A B L E S.")
(message "----------------------------------- \n")

(defvar *FZL_HOME* (getenv "FZL_HOME"))
(defvar *fzl_emacs_config_dir* (concat *FZL_HOME* "/etc/emacs"))
(defvar *fzl_emacsinitfile_dir* (concat *fzl_emacs_config_dir* "/sitelisp/emacsinitfile"))
(defvar *fzl_emacs_packages_checkouts* (concat *FZL_HOME* "/etc/emacs/sitelisp/packages-checkouts"))
...
(require  'config_lines_and_columns)
...
(add-to-list 'load-path 
             (concat *fzl_emacs_packages* "/auto-complete-1.3.1"))
(add-to-list 'load-path 
...
(defvar *cedet_home* (concat *fzl_emacs_packages* "/cedet-1.1")) 
